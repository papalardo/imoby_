<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">Contratos</h1>
    <div class="mb-6 flex justify-between items-center">
      ...
      <inertia-link class="btn-indigo" :href="route('contracts.create')">
        <span>Create</span>
      ...
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="contract in contracts.data" :key="contract.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          ...
          <td class="border-t w-px">
            <inertia-link class="px-4 flex items-center" :href="route('contracts.edit', contract.id)" tabindex="-1">
  ...
  watch: {
    form: {
      handler: throttle(function() {
        ...
        this.$inertia.replace(this.route('contracts', Object.keys(query).length ? query : { remember: 'forget' }))
      }, 150),
      deep: true,
    },
  },
