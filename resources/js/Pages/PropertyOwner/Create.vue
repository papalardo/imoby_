<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">
      <inertia-link class="text-indigo-400 hover:text-indigo-600" :href="route('locators')">Inquilinos</inertia-link>
...
export default {
  ...
  methods: {
    submit() {
      this.sending = true
      this.$inertia.post(this.route('locators.store'), this.form)
